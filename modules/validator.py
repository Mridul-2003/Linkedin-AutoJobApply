...
def validate_personals() -> Optional[Union[ValueError, TypeError]]:
...
def validate_questions() -> Optional[Union[ValueError, TypeError]]:
    global __validation_file_path
...
def validate_search() -> Optional[Union[ValueError, TypeError]]:
    global __validation_file_path
...
def validate_secrets() -> Optional[Union[ValueError, TypeError]]:
    global __validation_file_path
...
def validate_settings() -> Optional[Union[ValueError, TypeError]]:
    global __validation_file_path
