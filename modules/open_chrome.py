...
try:
    ...
    options.binary_location = "/usr/bin/google-chrome-stable" # Set correct path to chrome
    driver = webdriver.Chrome(executable_path="/usr/local/bin/chromedriver", options=options) # Set correct path to chromedriver
